module.exports = {
  ...
  rules: {
    ...
    "no-unused-vars": "off", // 사용 안 한 번수 경고 중복
    ...
    "obejct-curly-newline": "off", // { 다음 줄 바꿈을 강제로 사용하지 않는다.
    "react/jsx-one-expression-per-line": "off", // 한라인에 여러개의 JSX를 사용 할 수 있다.
    "implicit-arrow-linebreak": "off", //화살표 함수 다음에 줄 바꿈을 사용 할 수 있다.
    ...
    "global-require": "off", // 함수내에서 require 사용 가능
    "no-use-before-define": "off", // 선언전에 사용하지 불가
    ...
    "react/jsx-filename-extension": [
      1,
      {
        extensions: [".js", ".jsx", "tsx"] // jsx 사용 가능한 확장자 설명
      }
    ],
    "import/extensions": [
      "error",
